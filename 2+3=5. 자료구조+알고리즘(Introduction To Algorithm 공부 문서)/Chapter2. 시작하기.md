...
최종적으로 n개의 원소에 대한 INSERTION-SORT의 수행 시간 T(n)을 구하기 위해 비용과 횟수릐 곱을 합하면 다음과 같다.
...
결국 최악의 경우 수행 시간을 an^2 + bn + c로 표현할 수 있으며 이때 상수 a, b, c는 명령문의 비용 ck에 의해 결정된다. 다시 말해 수행 시간은 n에 관한 **이자 함수**이다.
